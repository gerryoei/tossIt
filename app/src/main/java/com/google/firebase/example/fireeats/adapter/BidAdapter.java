 ...
 */
public class BidAdapter extends FirestoreAdapter<BidAdapter.ViewHolder> {

    public BidAdapter(Query query) {
        super(query);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.bind(getSnapshot(position).toObject(Bid.class));
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Bid bid) {
            nameView.setText(bid.getUserName());
            ratingBar.setRating((float) bid.getRating());
            textView.setText(bid.getText());
        }
    }
