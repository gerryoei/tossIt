...
public class MainActivity extends AppCompatActivity implements
        ...
        TossItemAdapter.OnRestaurantSelectedListener {
    ...
    private TossItemAdapter mAdapter;
    ...
    private void initFirestore() {
        ...
        mQuery = mFirestore.collection("testitem")
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new TossItemAdapter(mQuery, this) {
    ...
    private void onAddItemsClicked() {
        ...
        for (int i = 0; i < 10; i++) {
            // Get a random TossItem POJO
            TossItem tossItem = TossItemUtil.getRandom(this);

            // Add a new document to the tossitem collection
            tossitem.add(tossItem);
        }
    }
    ...
    public void onFilter(Filters filters) {
        ...
        Query query = mFirestore.collection("testitem");
