...
public class Filters {
    ...
    public static Filters getDefault() {
        ...
        filters.setSortBy(TossItem.FIELD_AVG_RATING);
    ...
    public String getSearchDescription(Context context) {
        ...
        if (price > 0) {
            desc.append(" for ");
            desc.append("<b>");
            desc.append(TossItemUtil.getPriceString(price));
            desc.append("</b>");
        }
    ...
    public String getOrderDescription(Context context) {
        if (TossItem.FIELD_PRICE.equals(sortBy)) {
            return context.getString(R.string.sorted_by_price);
        } else if (TossItem.FIELD_POPULARITY.equals(sortBy)) {
